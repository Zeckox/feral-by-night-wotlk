...
FeralbyNight.L = {
	...
	["Faerie_Fire_Feral_Rank_6"] = "Faerie Fire (Feral)()",
	...
	["Swipe_Bear"] = "Swipe (Bear)",
	["Growl"] = "Growl",
	["Dire_Bear_Form"] = "Dire Bear Form",
	["Enrage"] = "Enrage",
	["Heroic_Presence_a"] = "Heroic Presence (a)",
	["Heroic_Presence_b"] = "Heroic Presence (b)",
	["Maim"] = "Maim",
	["Bash"] = "Bash",
}
...
FeralbyNight.L["Expose_Armor"] = GetSpellInfo(8647)
FeralbyNight.L["Sunder_Armor"] = GetSpellInfo(7386)
...
if language == "deDE" then
	FeralbyNight.L["Faerie_Fire_Feral_Rank_6"] = "Feenfeuer (Tiergestalt)(Rang 6)"
elseif language == "zhTW" then
	FeralbyNight.L["Faerie_Fire_Feral_Rank_6"] = "\231\178\190\233\157\136\228\185\139\231\129\171 (\233\135\142\230\128\167)(\231\173\137\231\180\154\229\133\173)"
elseif language == "ruRU" then
	FeralbyNight.L["Faerie_Fire_Feral_Rank_6"] = "\208\146\208\190\208\187\209\136\208\181\208\177\208\189\209\139\208\185 \208\190\208\179\208\190\208\189\209\140 (\208\183\208\178\208\181\209\128\209\140)(\208\163\209\128\208\190\208\178\208\181\208\189\209\140 6)" -- Needs review
elseif language == "frFR" then
	FeralbyNight.L["Faerie_Fire_Feral_Rank_6"] = "Lucioles (farouche)(Rang 6)"
end
...
FeralbyNight.getability = {
	...
	[2] = FeralbyNight.L["Survival_Instincts"],
	[3] = FeralbyNight.L["Barkskin"],
	[4] = FeralbyNight.L["Demoralizing_Roar"],
	[5] = FeralbyNight.L["Lacerate"],
	[6] = FeralbyNight.L["Growl"],
	[7] = FeralbyNight.L["Maim"],
	[8] = FeralbyNight.L["Berserk"],
	[9] = FeralbyNight.L["Faerie_Fire"],
	[10] = FeralbyNight.L["Mangle_Cat"],
	[11] = FeralbyNight.L["Rake"],
	[12] = FeralbyNight.L["Rip"],
	[13] = FeralbyNight.L["Savage_Roar"],
	[14] = FeralbyNight.L["Tigers_Fury"],
}
...
FeralbyNight.eventFrame:RegisterEvent("PLAYER_TARGET_CHANGED")
FeralbyNight.eventFrame:RegisterEvent("PLAYER_REGEN_ENABLED")
FeralbyNight.eventFrame:RegisterEvent("PLAYER_REGEN_DISABLED")
...
function FeralbyNight.events.ADDON_LOADED(addon)
	...
	if (playerClass ~= "DRUID" or playerlevel < 80) then
		...
		FeralbyNight.eventFrame:UnregisterEvent("PLAYER_TARGET_CHANGED")
		FeralbyNight.eventFrame:UnregisterEvent("PLAYER_REGEN_ENABLED")
		FeralbyNight.eventFrame:UnregisterEvent("PLAYER_REGEN_DISABLED")
...
function FeralbyNight.events.COMBAT_LOG_EVENT_UNFILTERED(timestamp, event, srcGUID, srcName, srcFlags, dstGUID, dstName,
                                                         dstFlags, arg9, arg10, arg11, arg12, ...)
	...
	elseif (event == "SPELL_CAST_SUCCESS") then
		if (
			FeralbyNight.noticestatus == "out of range" or FeralbyNight.noticestatus == "turn" or
				FeralbyNight.noticestatus == "can't use") then
...
function FeralbyNight:CreateGUI()
	...
	MeleeFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.MeleeFramefont,
		FeralbyNightdb.MeleeFramefontsize, "");
	...
	CPFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.cpFramefont,
		FeralbyNightdb.cpFramefontsize, "");
	CPFrame:SetBackdrop({
		bgFile = "Interface\\Tooltips\\UI-Tooltip-Background", tile = true, tileSize = 32,
	})
	...
	timetokillFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.cpFramefont,
		FeralbyNightdb.cpFramefontsize, "");
	...
	srFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.srFramefont,
		FeralbyNightdb.srFramefontsize, "");
	srFrame:SetBackdrop({
		bgFile = "Interface\\Tooltips\\UI-Tooltip-Background", tile = true, tileSize = 32,
	})
	...
	energyFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.energyFramefont,
		FeralbyNightdb.energyFramefontsize, "");
	...
	for i = 1, 5 do
		...
		cdmonFramedumb1:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.cdmonFramefont1,
			FeralbyNightdb.cdmonFramefontsize1, "");
	...
	for i = 1, 5 do
		...
		cdmonFramedumb2:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.cdmonFramefont2,
			FeralbyNightdb.cdmonFramefontsize2, "");
	...
	for i = 1, 5 do
		...
		cdmonFramedumb3:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.cdmonFramefont3,
			FeralbyNightdb.cdmonFramefontsize3, "");
	...
	for i = 1, 5 do
		...
		bossfightFramedumb:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.bossfightFramefont,
			FeralbyNightdb.bossfightFramefontsize, "");
	...
	for i = 1, 5 do
		...
		myfightFramedumb:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.myfightFramefont,
			FeralbyNightdb.myfightFramefontsize, "");
	...
	for i = 1, 5 do
		...
		procFramedumb:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.procFramefont,
			FeralbyNightdb.procFramefontsize, "");
	...
	hudFrame_healthbar:SetBackdrop({
		edgeFile = "Interface\\AddOns\\FeralbyNight\\arts\\border\\" .. FeralbyNightdb.bordertexture, tile = true,
		edgeSize = 16, insets = { left = 8, right = 8, top = 8, bottom = 8 }
	})
	hudFrame_healthbar_frame:SetFrameStrata("BACKGROUND");
	hudFrame_healthbar_frame:SetPoint("CENTER", 0, 0);
	hudFrame_healthbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	...
	hudFrame_powerbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	...
	hudFrame_castbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	...
	hudFrame_bosshealthbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	...
	hudFrame_bosspowerbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	...
	hudFrame_manabar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	...
	hudFrame_threatbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	...
	text_cap:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont,
		FeralbyNightdb.barfontsize, "")
	...
	if (FeralbyNightdb.cdmonshow2 == false or getglobal("CatForm") == nil) then
		FeralbyNight.cdmonFrame2:Hide()
	else
		FeralbyNight.cdmonFrame2:Show()
	end
	if (FeralbyNightdb.cdmonshow3 == false or getglobal("Bearform") == nil) then
...
function FeralbyNight:OnUpdate(elapsed)
	...
	while (FeralbyNight.timeSinceLastUpdate >= FeralbyNightdb.updateinterval) do
		...
		local spec = GetActiveTalentGroup(true, false);
		...
		if (
			((FeralbyNightdb.spec1 == true and spec == 1) or (FeralbyNightdb.spec2 == true and spec == 2)) and
				FeralbyNightdb.badspec == true) then
		...
		local name, rank, icon, powerCost, isFunnel, powerType, castingTime, minRange, maxRang = GetSpellInfo(FeralbyNight.L[
			"Mangle (Cat)"])
		...
		name, rank, icon, powerCost, isFunnel, powerType, castingTime, minRange, maxRang = GetSpellInfo(FeralbyNight.L[
			"Savage Roar"])
		sr_energy = powerCost;
		...
		local name, _, _, _, _, _, expirationTime, _, _ = UnitAura("player", FeralbyNight.L["Savage_Roar"]);
		if name ~= nil then
		...
		if (bearform ~= nil) then
			...
			name, _, _, _, _, _, expirationTime, _, _ = UnitAura("player", FeralbyNight.L["Survival_Instincts"]);
			if name ~= nil then
				sr_frame_count = expirationTime - currentTime
			end
		end
		...
		local name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
			FeralbyNight.L["Lacerate Debuff"]);
		...
		while ((currentTime - FeralbyNight.timeSinceLastUpdate_dps) >= FeralbyNightdb.killmodeupdateinterval) do
			...
			FeralbyNight.currentTarget.dps[10] = (FeralbyNight.currentTarget.bosshp[9] - FeralbyNight.currentTarget.bosshp[10]) /
				(FeralbyNight.currentTarget.bosshp_time[10] - FeralbyNight.currentTarget.bosshp_time[9])
			...
			FeralbyNight.damage = 0.15 * FeralbyNight.currentTarget.dps[10] + 0.14 * FeralbyNight.currentTarget.dps[9]
				...
				+ 0.11 * FeralbyNight.currentTarget.dps[6] + 0.10 * FeralbyNight.currentTarget.dps[5] +
				0.08 * FeralbyNight.currentTarget.dps[4]
				+ 0.07 * FeralbyNight.currentTarget.dps[3] + 0.06 * FeralbyNight.currentTarget.dps[2] +
				0.04 * FeralbyNight.currentTarget.dps[1];
			if (FeralbyNight.currentTarget.bosshp[1] > 0 and FeralbyNight.currentTarget.dps[1] > 0) then
				...
				if ((FeralbyNight.time_to_die > 0) and FeralbyNightdb.timetokillframeshow and FeralbyNight.time_to_die < 99999) then
					FeralbyNight.timetokillFrame:Show()
					if math.floor(FeralbyNight.time_to_die / 60) < 10 and
						(FeralbyNight.time_to_die - math.floor(FeralbyNight.time_to_die / 60) * 60) < 10 then
						FeralbyNight.timetokillFrame:SetText("0" ..
							string.format("%.0f", math.floor(FeralbyNight.time_to_die / 60)) ..
							":0" .. string.format("%.0f", FeralbyNight.time_to_die - math.floor(FeralbyNight.time_to_die / 60) * 60))
					elseif math.floor(FeralbyNight.time_to_die / 60) < 10 and
						(FeralbyNight.time_to_die - math.floor(FeralbyNight.time_to_die / 60) * 60) > 10 then
						FeralbyNight.timetokillFrame:SetText("0" ..
							string.format("%.0f", math.floor(FeralbyNight.time_to_die / 60)) ..
							":" .. string.format("%.0f", FeralbyNight.time_to_die - math.floor(FeralbyNight.time_to_die / 60) * 60))
					elseif math.floor(FeralbyNight.time_to_die / 60) > 10 and math.floor(FeralbyNight.time_to_die / 60) <= 59 and
						(FeralbyNight.time_to_die - math.floor(FeralbyNight.time_to_die / 60) * 60) < 10 then
						FeralbyNight.timetokillFrame:SetText(string.format("%.0f", math.floor(FeralbyNight.time_to_die / 60)) ..
							":0" .. string.format("%.0f", FeralbyNight.time_to_die - math.floor(FeralbyNight.time_to_die / 60) * 60))
					elseif math.floor(FeralbyNight.time_to_die / 60) > 10 and math.floor(FeralbyNight.time_to_die / 60) <= 59 and
						(FeralbyNight.time_to_die - math.floor(FeralbyNight.time_to_die / 60) * 60) > 10 then
						FeralbyNight.timetokillFrame:SetText(string.format("%.0f", math.floor(FeralbyNight.time_to_die / 60)) ..
		...
		if (catform ~= nil) then
			if (
				(FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Emalon - Lightning Nova"]) or
					(
					FeralbyNightdb.bossmode == true and
						FeralbyNight.castname == FeralbyNight.bosscast["Stormcaller - Council - Overload"]) or
					(FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Mimiron - Shock Blast"])) then
		...
		if (bearform ~= nil) then
			...
			if (
				(FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Emalon - Lightning Nova"]) or
					(
					FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Vezax - Surge of Darkness"] and
						isTanking ~= 0) or
					(
					FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Mimiron - Plasma Blast"] and
						isTanking ~= 0) or
					(
					FeralbyNightdb.bossmode == true and
						FeralbyNight.castname == FeralbyNight.bosscast["Steelbreaker - Council - Fusion Punch"] and isTanking ~= 0) or
					(
					FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Freya - Ground Tremor"] and
						isTanking ~= 0) or
					(
					FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Stonebark - Fist of Stone"] and
						isTanking ~= 0)) then
		...
		if (
			(FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Mimiron - Laser Barrage"]) or
				(FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Auriaya - Terrifying Screech"])
				or (FeralbyNightdb.bossmode == true and FeralbyNight.castname == FeralbyNight.bosscast["Auriaya - Sonic Screech"])) then
		...
		local name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitAura("target",
			FeralbyNight.bossaura["XT - Exposed Heart"]);
		if name ~= nil then
		...
		local catform, _, _, _, _, _, _, _, _ = UnitAura("player", FeralbyNight.L["Cat_Form"]);
		local bearform, _, _, _, _, _, _, _, _ = UnitAura("player", FeralbyNight.L["Dire_Bear_Form"]);
		...
		if pcastprc > 0 and FeralbyNightdb.showcast then
			...
			FeralbyNight.hudFrame_powerbar.text:SetText(string.sub(pspell, 1, 20) ..
				"  (" ..
				string.format("%.0f", ((1 - pcastprc) * 100)) ..
				"%)  " .. string.format("%.2f", ((1 - pcastprc) * pdurat)) .. "/" .. string.format("%.2f", pdurat))
		elseif power ~= nil and power ~= 0 and maxpower ~= nil and maxpower ~= 0 then
			FeralbyNight.hudFrame_powerbar.text:SetText(string.format("%.0f", power) ..
				power_unit .. "/" ..
				string.format("%.0f", maxpower) .. maxpower_unit .. "  (" .. string.format("%.0f", (powerpct) * 100) .. "%)")
		end
		if castprc > 0 and FeralbyNightdb.showcast then
			...
			FeralbyNight.hudFrame_bosspowerbar.text:SetText(string.sub(spell, 1, 20) ..
				"  (" ..
				string.format("%.0f", ((1 - castprc) * 100)) ..
				"%)  " .. string.format("%.2f", ((1 - castprc) * durat)) .. "/" .. string.format("%.2f", durat))
		elseif bosspower ~= nil and bosspower ~= 0 and bossmaxpower ~= nil and bossmaxpower ~= 0 then
			FeralbyNight.hudFrame_bosspowerbar.text:SetText(string.format("%.0f", bosspower) ..
				bosspower_unit ..
				"/" .. string.format("%.0f", bossmaxpower) ..
				bossmaxpower_unit .. "  (" .. string.format("%.0f", (bosspowerpct) * 100) .. "%)")
		end

		if health ~= nil and health ~= 0 and maxhp ~= nil and maxhp ~= 0 then
			FeralbyNight.hudFrame_healthbar.text:SetText(string.format("%.0f", health) ..
				health_unit .. "/" .. string.format("%.0f", maxhp) .. maxhp_unit .. "  (" .. string.format("%.0f", (hppct) * 100) ..
				"%)")

		end
		if bosshealth ~= nil and bosshealth ~= 0 and bossmaxhp ~= nil and bossmaxhp ~= 0 then
			FeralbyNight.hudFrame_bosshealthbar.text:SetText(string.sub(bossname, 1, 10) ..
				" (" ..
				bosslevel ..
				") " ..
				string.format("%.0f", bosshealth) ..
				bosshealth_unit ..
				"/" .. string.format("%.0f", bossmaxhp) .. bossmaxhp_unit .. "  (" .. string.format("%.1f", (bosshppct) * 100) ..
				"%)")
		end
		...
		local bearform, _, _, _, _, _, _, _, _ = UnitAura("player", FeralbyNight.L["Dire_Bear_Form"]);
		if (
			UnitName("target") == nil or UnitIsFriend("player", "target") ~= nil or UnitHealth("target") == 0 or
				((catform == nil) and (bearform == nil))) and FeralbyNightdb.locked == true then
			FeralbyNight.displayFrame_last:Hide()
			FeralbyNight.displayFrame_current:Hide()
			FeralbyNight.displayFrame_next:Hide()
			FeralbyNight.displayFrame_misc:Hide()
			...
			if (FeralbyNightdb.locked == false and FeralbyNightdb.showdummyvariables == true) then
				...
				FeralbyNight.textureList["current"]:SetTexture(GetSpellTexture(FeralbyNight.L["Mangle_Cat"]))
				--	FeralbyNight.textureList["next"]:SetTexture(GetSpellTexture(FeralbyNight.L["Rake"]))
				FeralbyNight.textureList["misc"]:SetTexture(GetSpellTexture(FeralbyNight.L["Tigers_Fury"]))
				--	FeralbyNight.textureList["int"]:SetTexture(GetSpellTexture(FeralbyNight.L["Savage_Roar"]))
			end
...
function FeralbyNight:ProcauraMonitor()
	...
	for i = 9, 13 do
		local name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitBuff("player",
			FeralbyNight.procindex[i]);
		if name ~= nil then
			local procFramedumb = _G["FeralbyNightprocFrame_" .. jj]
			...
			if FeralbyNight.getproc.stack[jj] == 0 then
				...
				if FeralbyNight.getproc.timer[jj] > 60 or FeralbyNight.getproc.timer[jj] <= 0 then
					...
					procFramedumb:SetText(string.format("%.0f", FeralbyNight.getproc.timer[jj]) ..
						"      " .. string.format("%.0f", FeralbyNight.getproc.stack[jj]))
				end
			end
		end
	end
	...
	if ((FeralbyNight.trinket1 == "nil" and FeralbyNight.trinket2 == "nil") or FeralbyNight.trinket1special == 1) then
		...
		for i = 14, 70 do
			...
			if (name ~= nil) then
				...
				if (
					FeralbyNight.trinket1 == (FeralbyNight.procindex[62]) or FeralbyNight.trinket1 == (FeralbyNight.procindex[63]) or
	...
	if ((FeralbyNight.trinket1 ~= "nil" and FeralbyNight.trinket2 == "nil") or FeralbyNight.trinket2special == 1) then
		...
		for i = 14, 70 do
			...
			if (name ~= nil and FeralbyNight.procindex[i] ~= FeralbyNight.trinket1) then
				...
				if (
					(
						FeralbyNight.trinket2 == (FeralbyNight.procindex[62]) or FeralbyNight.trinket2 == (FeralbyNight.procindex[63]) or
							FeralbyNight.trinket2 == (FeralbyNight.procindex[64])) and FeralbyNight.trinket1special == 0) then
...
function FeralbyNight:BossauraMonitor()
	...
	if FeralbyNightdb.bossfightshow == true then
		...
		local name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitBuff("target",
			FeralbyNight.bossaurabossindex[1]);

		for i = 1, 57 do
			if jj > 5 then break end
			local name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitBuff("target",
				FeralbyNight.bossaurabossindex[i]);
			if name ~= nil then
				local bossfightFramedumb = _G["FeralbyNightbossfightFrame_" .. jj]
				...
				if FeralbyNight.getbossaura.stack[jj] == 0 then
					...
					if FeralbyNight.getbossaura.timer[jj] > 60 or FeralbyNight.getbossaura.timer[jj] <= 0 then
						...
						bossfightFramedumb:SetText(string.format("%.0f", FeralbyNight.getbossaura.timer[jj]) ..
							"      " .. string.format("%.0f", FeralbyNight.getbossaura.stack[jj]))
					end
				end
				jj = jj + 1;
			end
		...
		for i = 1, 57 do
			if jj > 5 then break end
			name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
				FeralbyNight.bossaurabossindex[i]);
			if name ~= nil then
				local bossfightFramedumb = _G["FeralbyNightbossfightFrame_" .. jj]
				FeralbyNight.getbossaura.stack[jj] = count;
	...
	if FeralbyNightdb.myfightshow == true then
		...
		for i = 1, 57 do
			if jj > 5 then break end
			name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitBuff("player",
				FeralbyNight.bossauramyindex[i]);
			if name ~= nil then
				local myfightFramedumb = _G["FeralbyNightmyfightFrame_" .. jj]
				...
				if FeralbyNight.getmyaura.stack[jj] == 0 then
					...
					if FeralbyNight.getmyaura.timer[jj] > 60 or FeralbyNight.getmyaura.timer[jj] <= 0 then
						...
						myfightFramedumb:SetText(string.format("%.0f", FeralbyNight.getmyaura.timer[jj]) ..
							"      " .. string.format("%.0f", FeralbyNight.getmyaura.stack[jj]))
					end
				end
				jj = jj + 1;
			end
		...
		for i = 1, 57 do
			if jj > 5 then break end
			name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("player",
				FeralbyNight.bossauramyindex[i]);
			if name ~= nil then
				local myfightFramedumb = _G["FeralbyNightmyfightFrame_" .. jj]
				FeralbyNight.getmyaura.stack[jj] = count;
	...
	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitBuff("target",
		FeralbyNight.bossaura["Ignis - Strength of the Creator"])
...
function FeralbyNight:CooldownMonitor()
	...
	local name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Rip Debuff"]);
	if name ~= nil and caster == "player" then
		rip = expirationTime - currentTime
		if (
			(rip - FeralbyNight.old_rip) >= 0 and (rip - FeralbyNight.old_rip) <= 3 and (FeralbyNight.old_rip > 0) and (rip > 0)
				and FeralbyNight.shreded_rip < 3) then
	...
	local name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitAura("player",
		FeralbyNight.L["Barkskin"]);
	if name ~= nil then
		bark_up = expirationTime - currentTime
	end


	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitAura("player",
		FeralbyNight.L["Survival_Instincts"]);
	if name ~= nil then
	...
	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Rake Debuff"]);
	if name ~= nil and caster == "player" then
		rake = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Demoralizing Roar Debuff"]);
	if name ~= nil then
		demoshout = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Demoralizing_Shout"]);
	if name ~= nil then
		demoshout = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Curse_of_Weakness"]);
	if name ~= nil then
		demoshout = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Vindication"]);
	if name ~= nil then
		demoshout = expirationTime - currentTime
	end
	...
	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Mangle (Cat) Debuff"]);
	if name ~= nil then
		mangle = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Mangle (Bear) Debuff"]);
	if name ~= nil then
		mangle = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Trauma"]);
	if name ~= nil then
	...
	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Faerie_Fire_Feral"]);
	if name ~= nil then
		fffdur = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Sting"]);
	if name ~= nil then
		fffdur = expirationTime - currentTime
	end
	...
	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Faerie_Fire"]);
	if name ~= nil then
		fffdur = expirationTime - currentTime
	end


	local start, duration, enabled = GetSpellCooldown(FeralbyNight.L["Faerie_Fire_Feral_Rank_6"]);
	...
	local start, duration, enabled = GetSpellCooldown(FeralbyNight.L["Survival_Instincts"]);
	if duration ~= nil then
	...
	if rip > 0 then
		...
		if FeralbyNight.shredglyph == 1 then
			FeralbyNightcdmonFrame_12:SetText(string.format("%.0f", rip) ..
				"     " .. string.format("%.0f", FeralbyNight.shreded_rip))
		else
			FeralbyNightcdmonFrame_12:SetText(string.format("%.0f", rip))
		end
		if rip <= 2 then
	...
	start, duration, enabled = GetSpellCooldown(FeralbyNight.L["Tigers_Fury"]);
	if duration ~= nil then
...
function FeralbyNight:DecideSpells()
	...
	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitAura("player",
		FeralbyNight.L["Heroic_Presence_a"]);
	if name ~= nil then
		heropres = 1
	else
		name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitAura("player",
			FeralbyNight.L["Heroic_Presence_b"]);
		if name ~= nil then
			heropres = 1
		end
	end
	...
	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Heart_of_the_Crusader"]);
	if name ~= nil then
		crittaken = expirationTime - currentTime
	end

	name, rank, icon, count, debuffType, duration, expirationTime, caster, isStealable = UnitDebuff("target",
		FeralbyNight.L["Master_Poisoner"]);
	if name ~= nil then
		crittaken = expirationTime - currentTime
	end
	...
	local start, duration, enabled = GetSpellCooldown(FeralbyNight.L["Tigers_Fury"]);
	if duration ~= nil then
		tf = duration + start - currentTime
	...
	local Fb_damage = (1 - armorred) * (190 + (290 + 0.07 * real_ap) * 5 + (9.4 + real_ap * 0.002439) * extfben) * (1 + fa)
		* (fb_hit + fb_crit * 2 * (1 + pistinct) * (1 + FeralbyNight.crit_meta));
	local rake_damage = (
		(real_ap * 0.01 + 176) * (yhit + ycrit * 2 * (1 + pistinct) * (1 + FeralbyNight.crit_meta)) +
			(3 + twoT9) * (real_ap * 0.06 + 358) *
			(yhit + ycrit * (1 - fourT10) + fourT10 * ycrit * 2 * (1 + pistinct) * (1 + FeralbyNight.crit_meta))) * (1 + fury_m) *
		1.3 + idol_cryingmoon * 500;
	local shred_damage = (
		((real_ap / 14 + 54.857) * 2.25 + 666 + idol_shred * 203.0) * (yhit + ycrit * 2 * (1 + pistinct) *
			(1 + FeralbyNight.crit_meta))) * (1 + fury_m) * (1 + bleeds_up * ret_m1) * 1.3 * (1 - armorred);
	local rip_damagextick = 1.3 *
		((1 - (critChance + fourT9 * 0.05) * pg) + (critChance + fourT9 * 0.05) * pg * 2.0 * (1 + pistinct) *
			(1 + FeralbyNight.crit_meta)) * (real_ap * 0.01 * 5 + 36 + 21.0 * idol_ws * 5 + 93 * 5);
	...
	if (
		(FeralbyNight.shreded_rip < 3) and (rip < (2.5 * (3 - FeralbyNight.shreded_rip))) and (tf > (rip - 2)) and
			((rip - (shred_energy - energy) / 10) > GCD)) then
		shredder = 1;
	end
	if (
		(
			((rake_damage + twoT8_rate * 3 * shred_damage) / (rake_energy)) /
				((shred_damage + (FeralbyNight.rip_damagextick_saved * shredder)) / shred_energy)) < FeralbyNightdb.shredvsrake) then
		use_rake = 0;
	end
	...
	local avg_cp = {
		...
		(1 / yhitted) *
			(
			5 * yhit * yhit * yhit * yhit * yhit + 16 * ycrit * yhit * yhit * yhit + 5 * ycrit * yhit * yhit * yhit * yhit +
				9 * ycrit * ycrit * yhit + 3 * ycrit * ycrit * ycrit + 12 * ycrit * ycrit * yhit * yhit)
	};
	...
	local combovsfb_time = (
		(0.694 + 0.036 * manglebot) * shred_energy + (0.261 + 0.009 * manglebot) * rake_energy +
			0.045 * mangle_energy * (1 - manglebot)) * (cp_to_cycle / energy_x_sec) - (Fb_damage / rip_damagextick) * 2 +
		(sr_energy + rip_energy) / energy_x_sec;
	...
	local max_rip_downtime = (((Fb_damage / rip_damagextick) * 2) / FeralbyNightdb.ripvsfb) - ((FeralbyNightdb.ripvsfb - 1)
		/ 2)

	local ripvsfb_time = (
		(0.694 + 0.036 * manglebot) * shred_energy + (0.261 + 0.009 * manglebot) * rake_energy +
			0.045 * mangle_energy * (1 - manglebot)) * (avg_cp[5] / energy_x_sec) - max_rip_downtime + (rip_energy) / energy_x_sec;
	...
	local srvsfb_time = FeralbyNightdb.srvsfinisher *
		(
		((0.694 + 0.036 * manglebot) * shred_energy + (0.261 + 0.009 * manglebot) * rake_energy +
			0.045 * mangle_energy * (1 - manglebot)) * (avg_cp[FeralbyNightdb.SRCP] / energy_x_sec));
	...
	if bearform ~= nil then
		FeralbyNightMeleeFrame:SetText(string.format("%.3f", mainSpeed) ..
			" Speed, " ..
			string.format("%.3f", haste) ..
			"% haste |n" ..
			string.format("%.3f", missChance) ..
			"% miss, " ..
			string.format("%.3f", dodgechance) ..
			"% dodged |n" ..
			string.format("%.3f", armorPenetration) ..
			"% ArPen, " ..
			string.format("%.3f", armorred * 100) ..
			"% dmg red |n" ..
			real_ap .. " AP, " ..
			string.format("%.3f", critChance * 100) .. "% crit |n" .. savage_defense_absorb .. " Savage Defense Shield");
	else
		FeralbyNightMeleeFrame:SetText(string.format("%.3f", mainSpeed) ..
			" Speed, " ..
			string.format("%.3f", haste) ..
			...
			"% ArPen, " ..
			string.format("%.3f", armorred * 100) ..
			"% dmg red |n" .. real_ap .. " AP, " .. string.format("%.3f", critChance * 100) .. "% crit");
	end
	...
	local start, duration, _ = GetSpellCooldown(FeralbyNight.L["Survival_Instincts"]);
	if duration ~= nil then
		surv = duration + start - currentTime
	end
	...
	start, duration, enabled = GetSpellCooldown(FeralbyNight.L["Mangle_Bear"]);
	if duration ~= nil then
	...
	spell = FeralbyNight:NextSpell(energy, cp, GCD, ooc, rip, rake, mangle, trauma, sr, tf, berserk, fff, fffdur,
		combovsfb_time, combovsfb_time_koj, ripvsfb_time, ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname,
		mangle_energy, rake_energy, shred_energy, sr_energy, fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage,
		bark, surv, lacerate, lacerate_stack, demoshout, growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage,
		max_rip_downtime, demoshout_rage, rage, use_rake, maim, maim_energy, bash, bash_rage, finish, durat, castname, bleeds,
		energy_x_sec)
	if FeralbyNightdb.showPrediction == true then
		if spell == FeralbyNight.L["Tigers_Fury"] then
			nextspell = FeralbyNight:NextSpell(energy + koj_m1, cp, GCD, ooc - lag, rip - lag, rake - lag, mangle - lag,
				trauma - lag, sr - lag, tf - lag, berserk - lag, fff - lag, fffdur, combovsfb_time, combovsfb_time_koj, ripvsfb_time
				, ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy
				, fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
				maim - 1, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds, energy_x_sec)
			intspell = nextspell
		elseif spell == FeralbyNight.L["Mangle_Cat"] then
			nextspell = FeralbyNight:NextSpell(energy - mangle_energy * ooc_down + 10, cp + 1, GCD, 0, rip - 1, rake - 1, 17,
				trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
				maim - 1, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds - 1, energy_x_sec)
			intspell = FeralbyNight:NextSpell(energy - mangle_energy * ooc_down + 10, cp + 2, GCD, 0, rip - 1, rake - 1, 17,
				trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
		...
		elseif spell == FeralbyNight.L["Maim"] then
			nextspell = FeralbyNight:NextSpell(energy - maim_energy * ooc_down + 10, 0, GCD, 0, rip - 1, rake - 1, 17, trauma - 1
				, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
				maim, maim_energy, bash, bash_rage, finish - 10, -10, castname, bleeds + 5, energy_x_sec)
			intspell = nextspell
		elseif spell == FeralbyNight.L["Shred"] then
			nextspell = FeralbyNight:NextSpell(energy - shred_energy * ooc_down + 10, cp + 1, GCD, 0, rip - 1, rake - 1,
				mangle - 1, trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj,
				ripvsfb_time, ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy
				, sr_energy, fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack,
				demoshout, growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage,
				use_rake, maim - 1, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds - 1, energy_x_sec)
			intspell = FeralbyNight:NextSpell(energy - shred_energy * ooc_down + 10, cp + 2, GCD, 0, rip - 1, rake - 1, mangle - 1
				, trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
		...
		elseif spell == FeralbyNight.L["Rake"] then
			nextspell = FeralbyNight:NextSpell(energy - rake_energy * ooc_down + 10, cp + 1, GCD, 0, rip - 1, 8, mangle - 1,
				trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
				maim - 1, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds + 8, energy_x_sec)
			intspell = FeralbyNight:NextSpell(energy - rake_energy * ooc_down + 10, cp + 2, GCD, 0, rip - 1, 8, mangle - 1,
				trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
		...
		elseif spell == FeralbyNight.L["Rip"] then
			nextspell = FeralbyNight:NextSpell(energy - rip_energy * ooc_down + 10, 0, GCD, 0, rip - 1, rake - 1, mangle - 1,
				trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
				maim - 1, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds + 11, energy_x_sec)
			intspell = nextspell
		elseif spell == FeralbyNight.L["Savage_Roar"] then
			nextspell = FeralbyNight:NextSpell(energy - sr_energy + 10, 0, GCD, ooc - 1, rip - 1, rake - 1, mangle - 1, trauma - 1
				, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
				ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
				fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
				growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
				maim - 1, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds - 1, energy_x_sec)
			intspell = nextspell
		elseif spell == FeralbyNight.L["Ferocious_Bite"] then
			if energy >= (fb_energy * ooc_down + 30) then
				nextspell = FeralbyNight:NextSpell(energy - fb_energy * ooc_down - 30 + 10, 0, GCD, 0, rip - 1, rake - 1, mangle - 1
					, trauma - 1, sr - 1, tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time,
					ripvsfb_time_koj, srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
					fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout,
					growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake,
				...
				nextspell = FeralbyNight:NextSpell(10, 0, GCD, 0, rip - 1, rake - 1, mangle - 1, trauma - 1, sr - 1, tf - 1,
					berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time, ripvsfb_time_koj, srvsfb_time,
					srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy, fb_energy, rip_energy, koj_m1,
					status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout, growl, mangle_bear_rage,
					mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake, maim - 1, maim_energy,
					bash, bash_rage, finish - 1, durat, castname, bleeds - 1, energy_x_sec)
				intspell = nextspell
			end
		elseif spell == FeralbyNight.L["Berserk"] then
			nextspell = FeralbyNight:NextSpell(energy + 10, cp, GCD, ooc - 1, rip - 1, rake - 1, mangle - 1, trauma - 1, sr - 1,
				tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time, ripvsfb_time_koj,
				srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy / 2, rake_energy / 2, shred_energy / 2, sr_energy / 2,
				fb_energy / 2, rip_energy / 2, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack,
				demoshout, growl, mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage,
				use_rake, maim - 1, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds - 1, energy_x_sec)
			intspell = nextspell
		elseif spell == "" then
			nextspell = FeralbyNight:NextSpell(energy + 10, cp, GCD, ooc - 1, rip - 1, rake - 1, mangle - 1, trauma - 1, sr - 1,
				tf - 1, berserk - 1, fff - 1, fffdur - 1, combovsfb_time, combovsfb_time_koj, ripvsfb_time, ripvsfb_time_koj,
				srvsfb_time, srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy, fb_energy,
				rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate, lacerate_stack, demoshout, growl,
				mangle_bear_rage, mangle_bear, swipe_rage, lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake, maim - 1
				, maim_energy, bash, bash_rage, finish - 1, durat, castname, bleeds - 1, energy_x_sec)
			intspell = nextspell
		end
	end
...
function FeralbyNight:NextSpell(energy, cp, GCD, ooc, rip, rake, mangle, trauma, sr, tf, berserk, fff, fffdur,
                                combovsfb_time, combovsfb_time_koj, ripvsfb_time, ripvsfb_time_koj, srvsfb_time,
                                srvsfb_time_koj, lag, bossname, mangle_energy, rake_energy, shred_energy, sr_energy,
                                fb_energy, rip_energy, koj_m1, status, catform, bearform, enrage, bark, surv, lacerate,
                                lacerate_stack, demoshout, growl, mangle_bear_rage, mangle_bear, swipe_rage,
                                lacerate_rage, max_rip_downtime, demoshout_rage, rage, use_rake, maim, maim_energy, bash
                                , bash_rage, finish, durat, castname, bleeds, energy_x_sec)
	...
	if (
		FeralbyNight.currentTarget.id == FeralbyNight.bossid["Training Dummy"] or
			FeralbyNight.currentTarget.id == FeralbyNight.bossid["Heroic Training Dummy"] or
			FeralbyNight.currentTarget.id == FeralbyNight.bossid["Expert's Training Dummy"] or
			FeralbyNight.currentTarget.id == FeralbyNight.bossid["Master's Training Dummy"] or
			FeralbyNight.currentTarget.id == FeralbyNight.bossid["Grandmaster's Training Dummy"]) then
		FeralbyNight.time_to_die = 60
	end


	if (
		(FeralbyNightdb.shred == false) or
			((status == 2) and
				(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id ~= FeralbyNight.bossid["Razorscale"])) or
			((status == 3) and
				(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id ~= FeralbyNight.bossid["Razorscale"])) or
			(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id == FeralbyNight.bossid["Flame Leviathan Turret"])
			or (FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id == FeralbyNight.bossid["Kologarn body"]) or
			(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id == FeralbyNight.bossid["Kologarn left arm"]) or
			(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id == FeralbyNight.bossid["Kologarn right arm"]) or
			(
			FeralbyNightdb.bossmode == true and FeralbyNightdb.shredontentacles == false and
				FeralbyNight.currentTarget.id == FeralbyNight.bossid["Crusher Tentacle"]) or
			(
			FeralbyNightdb.bossmode == true and FeralbyNightdb.shredontentacles == false and
				FeralbyNight.currentTarget.id == FeralbyNight.bossid["Constrictor Tentacle"]) or
			(
			FeralbyNightdb.bossmode == true and FeralbyNightdb.shredontentacles == false and
				FeralbyNight.currentTarget.id == FeralbyNight.bossid["Corruptor Tentacle"]) or
			(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id == FeralbyNight.bossid["Living Constellation"]) or
			(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id == FeralbyNight.bossid["Collapsing Star"]) or
			(FeralbyNightdb.bossmode == true and FeralbyNight.currentTarget.id == FeralbyNight.bossid["Eonar's Gift"])) then
		shred_status = 0
	end
	...
	if (catform ~= nil) then
		...
		if (
			(
				(FeralbyNightdb.suggestinterrupt == true and durat > FeralbyNightdb.mincasttime) or
					(
					FeralbyNightdb.bossmode == true and
						(
						(castname == FeralbyNight.bosscast["Razor-Watcher-Chain 1"] and FeralbyNightdb.interrupt.razorchain == true) or
							(castname == FeralbyNight.bosscast["Razor-Watcher-Chain 2"] and FeralbyNightdb.interrupt.razorchain == true) or
							(
							castname == FeralbyNight.bosscast["Stormcaller - Council - Chain Lightning"] and
								FeralbyNightdb.interrupt.stormchain == true) or
							(
							castname == FeralbyNight.bosscast["Stormcaller - Council - Lightning Whirl"] and
								FeralbyNightdb.interrupt.stormwhirl == true) or
							(castname == FeralbyNight.bosscast["Auriaya - Sentinel Blast"] and FeralbyNightdb.interrupt.sentinelblast == true
							) or
							(castname == FeralbyNight.bosscast["Thorim - Acolyte - Greater Heal"] and FeralbyNightdb.interrupt.thorimGL ==
								true) or
							(castname == FeralbyNight.bosscast["Thorim - Evoker - Runic Mending"] and FeralbyNightdb.interrupt.thorimRM ==
								true) or
							(castname == FeralbyNight.bosscast["Vezax - Searing Flame"] and FeralbyNightdb.interrupt.searingflame == true) or
							(castname == FeralbyNight.bosscast["Yogg - Dark volley"] and FeralbyNightdb.interrupt.darkvolley == true) or
							(castname == FeralbyNight.bosscast["Yogg - Drain Life"] and FeralbyNightdb.interrupt.drainlife == true) or
							(castname == FeralbyNight.bosscast["Yogg - Drain Life"] and FeralbyNightdb.interrupt.drainlife == true)))) and
				finish > lag and maim <= lag and energy >= maim_energy and cp > 0) then
			return FeralbyNight.L["Maim"]


		elseif (
			(
				FeralbyNightdb.bossmode == true and (FeralbyNight.currentTarget.id == FeralbyNight.bossid["XT-002"]) and
					(FeralbyNightdb.saveforheart == true) and (FeralbyNight.bosslifepc < 0.78 and FeralbyNight.bosslifepc > 0.70)) and
				sr < 19 and cp >= 2 and (energy >= sr_energy or ooc > 0)) then
			return FeralbyNight.L["Savage_Roar"]
		...
		elseif (
			(((sr <= lag) and (cp > 0)) or (cp == 5 and sr < srvsfb_time)) and (energy >= sr_energy or ooc > 0) and
				(sr < FeralbyNight.time_to_die or FeralbyNightdb.killmode == false)) then
			return FeralbyNight.L["Savage_Roar"]

		elseif ((ooc > 0) and (shred_status == 1)) then
			if (mangle <= lag and trauma <= lag) then
				return FeralbyNight.L["Mangle_Cat"]
			else
		...
		elseif (
			(tf <= lag) and (energy < (95 - koj_m1)) and (berserk < (165 - FeralbyNight.berserkplyph)) and
				(cp < 5 or rip < ((95 - koj_m1) / 10)) and
				(
				(FeralbyNightdb.bossmode == false) or (FeralbyNight.currentTarget.id ~= FeralbyNight.bossid["XT-002"]) or
					(FeralbyNightdb.saveforheart == false) or (FeralbyNight.bosslifepc > 0.78 or FeralbyNight.bosslifepc < 0.70))) then
			return FeralbyNight.L["Tigers_Fury"]


		elseif (
			(berserk <= lag) and (energy >= 70) and (sr > GCD + lag) and (FeralbyNightdb.Berserk == true) and
				(
				(FeralbyNightdb.bossmode == false) or
					(
					FeralbyNight.currentTarget.id ~= FeralbyNight.bossid["XT-002"] or
						FeralbyNight.currentTarget.id ~= FeralbyNight.bossid["Dark Rune Watcher"] or
						FeralbyNight.currentTarget.id ~= FeralbyNight.bossid["Dark Rune Sentinel"] or
						FeralbyNight.currentTarget.id ~= FeralbyNight.bossid["Dark Rune Guardian"]) or
					(FeralbyNight.currentTarget.id == FeralbyNight.bossid["XT-002"] and FeralbyNightdb.saveforheart == false) or
					(FeralbyNight.currentTarget.id == FeralbyNight.bossid["XT-002"] and FeralbyNight.bosslifepc < 0.70) or
					(
					(
						FeralbyNight.currentTarget.id == FeralbyNight.bossid["Dark Rune Watcher"] or
							FeralbyNight.currentTarget.id == FeralbyNight.bossid["Dark Rune Sentinel"] or
							FeralbyNight.currentTarget.id == FeralbyNight.bossid["Dark Rune Guardian"]) and FeralbyNightdb.saveforrazor ==
						false))) then
		...
		elseif (
			(rake <= lag) and cp < 5 and (mangle > lag or trauma > lag) and (rake_status == 1) and (energy >= rake_energy) and
				((mangle > ((rake_energy + mangle_switch * mangle_energy - 10 - energy) / 10)) or cp >= FeralbyNightdb.energypooling
				) and (FeralbyNight.time_to_die >= 9 or FeralbyNightdb.killmode == false)) then
			return FeralbyNight.L["Rake"]

		elseif (
			(energy >= mangle_energy) and cp < 5 and ((shred_status == 0) or (shred_energy > 49)) and
				(
				(
					(
						(
							tf < ((shred_energy + rake_energy - 10 - energy) / 10) and
								(
								(
									((rake > ((mangle_energy + rake_energy - 10 - koj_m1 - energy) / 10))) and cp < 3 and
										(mangle > lag + GCD or trauma > lag + GCD) and
										((((rake > lag) or (FeralbyNight.time_to_die < 9 and FeralbyNightdb.killmode == true))) or rake_status == 0))
									or sr < (GCD + lag))) or
							(
							(
								(
									((rake > ((mangle_energy + rake_energy - 10 - energy) / 10))) and cp < 3 and
										((rake > lag) or (FeralbyNight.time_to_die < 9 and FeralbyNightdb.killmode == true))) or sr < (GCD + lag)))) or
						cp >= FeralbyNightdb.energypooling) or (FeralbyNight.time_to_die < 4))) then
			return FeralbyNight.L["Mangle_Cat"]

		elseif (
			(
				(energy >= shred_energy) and cp < 5 and (shred_status == 1) and
					(
					(
						(
							(
								tf < ((shred_energy + rake_energy - 10 - energy) / 10) and
									(
									(
										mangle > ((shred_energy + mangle_switch * mangle_energy - 10 - koj_m1 - energy) / 10) and
											((rake > ((shred_energy + rake_energy - 10 - koj_m1 - energy) / 10)) or rake_status == 0) and cp < 3 and
											(mangle > lag + GCD or trauma > lag + GCD) and
											((rake > lag) or (FeralbyNight.time_to_die < 9 and FeralbyNightdb.killmode == true))) or sr < (GCD + lag))) or
								(
								(
									(
										mangle > ((shred_energy + mangle_switch * mangle_energy - 10 - energy) / 10) and
											((rake > ((shred_energy + rake_energy - 10 - energy) / 10)) or rake_status == 0) and cp < 3 and
											(mangle > lag + GCD or trauma > lag + GCD) and
											((((rake > lag) or (FeralbyNight.time_to_die < 9 and FeralbyNightdb.killmode == true))) or rake_status == 0))
										or sr < (GCD + lag)))) or cp >= FeralbyNightdb.energypooling) or
						((FeralbyNight.time_to_die < 4) and FeralbyNightdb.killmode == true)))) then
			return FeralbyNight.L["Shred"]

		elseif (
			((sr > lag) and (energy >= fb_energy or ooc > 0) and (cp == 5)) and
				(
				(
					(berserk <= (165 - FeralbyNight.berserkplyph)) and
						(
						(
							(
								((rip + sr) > (ripvsfb_time + srvsfb_time)) or ((tf < ripvsfb_time) and ((rip + sr) >
									(ripvsfb_time_koj + srvsfb_time))) or ((tf < srvsfb_time) and ((rip + sr) > (srvsfb_time_koj + ripvsfb_time))))
								and ((rip > ripvsfb_time) or ((tf < ripvsfb_time) and (rip > ripvsfb_time_koj))) and
								((sr > srvsfb_time) or ((tf < srvsfb_time) and (sr > srvsfb_time_koj)))) or
							((FeralbyNight.time_to_die < (max_rip_downtime + 2)) and FeralbyNightdb.killmode == true))) or
					(
					((berserk > (165 - FeralbyNight.berserkplyph) and energy < (fb_energy + 5))) and
						(
						(
							(
								((rip + sr) > (ripvsfb_time * 1.8 + srvsfb_time * 1.8)) or
									((tf < ripvsfb_time) and ((rip + sr) > (ripvsfb_time_koj * 1.5 + srvsfb_time * 1.8))) or
									((tf < srvsfb_time) and ((rip + sr) > (srvsfb_time_koj * 1.5 + ripvsfb_time * 1.8)))) and
								((rip > ripvsfb_time * 1.8) or ((tf < ripvsfb_time) and (rip > ripvsfb_time_koj * 1.5))) and
								((sr > srvsfb_time * 1.8) or ((tf < srvsfb_time) and (sr > srvsfb_time_koj * 1.5)))) or
							((FeralbyNight.time_to_die < (max_rip_downtime + 2)) and FeralbyNightdb.killmode == true))))) then
			return FeralbyNight.L["Ferocious_Bite"]


		elseif (
			(sr > lag) and (energy >= rip_energy or ooc > 0) and (cp == 5) and ((rip <= lag)) and
				((FeralbyNight.time_to_die > (max_rip_downtime + 2)) or FeralbyNightdb.killmode == false)) then
			return FeralbyNight.L["Rip"]


		elseif (
			(
				((energy >= (rake_energy + rip_energy - 10)) or
					((energy >= (fb_energy + 5)) and berserk > (165 - FeralbyNight.berserkplyph))) and (rip >= GCD + lag) and cp == 5)) then
			if ((mangle <= lag and trauma <= lag) and (rip >= GCD) and (bleeds > 0 or FeralbyNightdb.manglepriority == 2)) then
				return FeralbyNight.L["Mangle_Cat"]
			elseif (
				(rake <= lag) and (rip >= GCD) and (rake_status == 1) and
					((FeralbyNight.time_to_die >= 9) or FeralbyNightdb.killmode == false)) then
				return FeralbyNight.L["Rake"]

			elseif (
				((energy >= 90) or ((energy >= shred_energy) and berserk > (165 - FeralbyNight.berserkplyph))) and
					((shred_status == 0) or (shred_energy > 49)) and (mangle >= GCD or trauma >= GCD) and (rake >= GCD) and (rip >= GCD
					) and cp == 5) then
				return FeralbyNight.L["Mangle_Cat"]

			elseif (
				((energy >= 90) or ((energy >= shred_energy) and berserk > (165 - FeralbyNight.berserkplyph))) and (shred_status == 1
					) and (mangle >= GCD or trauma >= GCD) and ((rake >= GCD) or rake_status == 0) and (rip >= GCD) and cp == 5) then
				return FeralbyNight.L["Shred"]

			end

		elseif ((FeralbyNightdb.FFF == true) and (fff <= lag) and (fffdur < 7)) then
			return FeralbyNight.L["Faerie_Fire_Feral_Rank_6"]
		end
				...
				(FeralbyNightdb.suggestinterrupt == true and durat > FeralbyNightdb.mincasttime) or
					...
					FeralbyNightdb.bossmode == true and
						...
						(castname == FeralbyNight.bosscast["Razor-Watcher-Chain 1"] and FeralbyNightdb.interrupt.razorchain == true) or
							...
							(castname == FeralbyNight.bosscast["Yogg - Drain Life"] and FeralbyNightdb.interrupt.drainlife == true) or
							(castname == FeralbyNight.bosscast["Yogg - Drain Life"] and FeralbyNightdb.interrupt.drainlife == true)))) and
				finish > lag and bash <= lag and rage >= bash_rage) then
		...
		elseif (mangle_bear <= lag and rage >= mangle_bear_rage) then
			return FeralbyNight.L["Mangle_Bear"]
...
function FeralbyNight:SetsrFont(num)
	...
	FeralbyNight.srFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.srFramefont,
		FeralbyNightdb.srFramefontsize, "");
end
...
function FeralbyNight:SetMeleeFont(num)
	...
	FeralbyNight.MeleeFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.MeleeFramefont,
		FeralbyNightdb.MeleeFramefontsize, "");
end
...
function FeralbyNight:SetenergyFont(num)
	...
	FeralbyNight.energyFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.energyFramefont
		, FeralbyNightdb.energyFramefontsize, "");
end
...
function FeralbyNight:SettimetokillFont(num)
	...
	FeralbyNight.timetokillFrame:SetFont("P",
		"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.timetokillFramefont,
		FeralbyNightdb.timetokillFramefontsize, "");
end
...
function FeralbyNight:SetcpFont(num)
	...
	FeralbyNight.CPFrame:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.cpFramefont,
		FeralbyNightdb.cpFramefontsize, "");
end
...
function FeralbyNight:SetbarFont(num)
	...
	FeralbyNight.hudFrame_manabar.text:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
	FeralbyNight.hudFrame_threatbar.text:SetFont("P",
		"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
	FeralbyNight.hudFrame_castbar.text:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
	FeralbyNight.hudFrame_bosspowerbar.text:SetFont("P",
		"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
	FeralbyNight.hudFrame_healthbar.text:SetFont("P",
		"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
	FeralbyNight.hudFrame_bosshealthbar.text:SetFont("P",
		"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
	FeralbyNight.hudFrame_powerbar.text:SetFont("P",
		"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
end

function FeralbyNight:Setbartexture(num)
	FeralbyNightdb.bartexture = FeralbyNight.texturevector[num]
	FeralbyNight.hudFrame_manabar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	FeralbyNight.hudFrame_castbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	FeralbyNight.hudFrame_threatbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	FeralbyNight.hudFrame_bosspowerbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	FeralbyNight.hudFrame_healthbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	FeralbyNight.hudFrame_bosshealthbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
	FeralbyNight.hudFrame_powerbar_frame:SetStatusBarTexture("Interface\\AddOns\\FeralbyNight\\arts\\statusbar\\" ..
		FeralbyNightdb.bartexture);
end
...
function FeralbyNight:SetcdmonFont1(num)
	...
	FeralbyNightcdmonFrame1_1:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont1, FeralbyNightdb.cdmonFramefontsize1, "");
	FeralbyNightcdmonFrame1_2:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont1, FeralbyNightdb.cdmonFramefontsize1, "");
	FeralbyNightcdmonFrame1_3:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont1, FeralbyNightdb.cdmonFramefontsize1, "");
	FeralbyNightcdmonFrame1_4:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont1, FeralbyNightdb.cdmonFramefontsize1, "");
	FeralbyNightcdmonFrame1_5:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont1, FeralbyNightdb.cdmonFramefontsize1, "");
end
...
function FeralbyNight:SetcdmonFont2(num)
	...
	FeralbyNightcdmonFrame2_1:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont2, FeralbyNightdb.cdmonFramefontsize2, "");
	FeralbyNightcdmonFrame2_2:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont2, FeralbyNightdb.cdmonFramefontsize2, "");
	FeralbyNightcdmonFrame2_3:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont2, FeralbyNightdb.cdmonFramefontsize2, "");
	FeralbyNightcdmonFrame2_4:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont2, FeralbyNightdb.cdmonFramefontsize2, "");
	FeralbyNightcdmonFrame2_5:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont2, FeralbyNightdb.cdmonFramefontsize2, "");
end
...
function FeralbyNight:SetcdmonFont3(num)
	...
	FeralbyNightcdmonFrame3_1:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont3, FeralbyNightdb.cdmonFramefontsize3, "");
	FeralbyNightcdmonFrame3_2:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont3, FeralbyNightdb.cdmonFramefontsize3, "");
	FeralbyNightcdmonFrame3_3:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont3, FeralbyNightdb.cdmonFramefontsize3, "");
	FeralbyNightcdmonFrame3_4:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont3, FeralbyNightdb.cdmonFramefontsize3, "");
	FeralbyNightcdmonFrame3_5:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" ..
		FeralbyNightdb.cdmonFramefont3, FeralbyNightdb.cdmonFramefontsize3, "");
end
...
function FeralbyNight:CreateOptionFrame()
	...
	slider11:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setupdateinterval(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider2:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider3:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetcdmonScale1(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider3cat:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetcdmonScale2(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider3bear:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetcdmonScale3(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider4:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetMeleeScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider50:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetCPScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider6:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetenergyScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider7:SetScript("OnValueChanged",
		function(self) FeralbyNight:SethudScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider8:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetoocScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider9:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetsrScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider90:SetScript("OnValueChanged",
		function(self) FeralbyNight:SettimetokillScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider8000:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetnoticeScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider8200:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetprocScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider401:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetsrFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring401
			:SetText("SR/CD Frame Font: " .. FeralbyNightdb.srFramefont) end)
	...
	slider4012:SetScript("OnValueChanged",
		function(self) FeralbyNightdb.srFramefontsize = tostring(self:GetValue()); FeralbyNight.srFrame:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.srFramefont, FeralbyNightdb.srFramefontsize, ""); _G
			[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider402:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetenergyFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring402
			:SetText("energy/rage Frame Font: " .. FeralbyNightdb.energyFramefont) end)
	...
	slider4022:SetScript("OnValueChanged",
		function(self) FeralbyNightdb.energyFramefontsize = tostring(self:GetValue()); FeralbyNight.energyFrame:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.energyFramefont, FeralbyNightdb.energyFramefontsize
	...
	slider403:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetcpFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring403
			:SetText("cp/lacerate Frame Font: " .. FeralbyNightdb.cpFramefont) end)
	...
	slider4032:SetScript("OnValueChanged",
		function(self) FeralbyNightdb.cpFramefontsize = tostring(self:GetValue()); FeralbyNight.CPFrame:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.cpFramefont, FeralbyNightdb.cpFramefontsize, ""); _G
			[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider404:SetScript("OnValueChanged",
		function(self) FeralbyNight:SettimetokillFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring404
			:SetText("Time to Die Frame Font: " .. FeralbyNightdb.timetokillFramefont) end)
	...
	slider4042:SetScript("OnValueChanged",
		function(self) FeralbyNightdb.timetokillFramefontsize = tostring(self:GetValue()); FeralbyNight.timetokillFrame:
			SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.timetokillFramefont,
				FeralbyNightdb.timetokillFramefontsize, ""); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider405:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetMeleeFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring405
			:SetText("Stats Frame Font: " .. FeralbyNightdb.MeleeFramefont) end)
	...
	slider4052:SetScript("OnValueChanged",
		function(self) FeralbyNightdb.MeleeFramefontsize = tostring(self:GetValue()); FeralbyNight.MeleeFrame:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.MeleeFramefont, FeralbyNightdb.MeleeFramefontsize,
			""); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider408:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetcdmonFont1(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring408
			:SetText("CD monitor Frame Font: " .. FeralbyNightdb.cdmonFramefont1) end)
	...
	slider409:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetcdmonFont2(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring409
			:SetText("cat monitor Frame Font: " .. FeralbyNightdb.cdmonFramefont2) end)
	...
	slider410:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetcdmonFont3(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring410
			:SetText("Bear monitor Frame Font: " .. FeralbyNightdb.cdmonFramefont3) end)
	...
	slider412:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetbarFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring412
			:SetText("Hud Font: " .. FeralbyNightdb.barfont) end)
	...
	slider4123:SetScript("OnValueChanged", function(self) FeralbyNightdb.barfontsize = tostring(self:GetValue());
		FeralbyNight.hudFrame_manabar.text:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
		FeralbyNight.hudFrame_threatbar.text:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
		FeralbyNight.hudFrame_castbar.text:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
		FeralbyNight.hudFrame_bosspowerbar.text:SetFont("P",
			"Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.barfont, FeralbyNightdb.barfontsize, "");
		FeralbyNight.hudFrame_healthbar.text:SetFont("P",
	...
	slider4124:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setbartexture(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring4124
			:SetText("Hud Bar texture: " .. FeralbyNightdb.bartexture) end)
...
function FeralbyNight:CreateOptionFrame1()
	...
	slider1:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetSRCP(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider78:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setkillmodeupdateinterval(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:
			GetValue()) end)
	...
	slider781:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setinterruptinterval(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider782:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setenergypooling(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider783:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setripvsfb(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider784:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setsrvsfinisher(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider785:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setshredvsrake(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider786:SetScript("OnValueChanged",
		function(self) FeralbyNight:Setmanglepriority(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
...
function FeralbyNight:CreateOptionFrame5()
	...
	slider3888:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetmyfightScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider3889:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetbossfightScale(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()) end)
	...
	slider506:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetbossfightFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring506
			:SetText("boss fight buff/debuff Frame Font: " .. FeralbyNightdb.bossfightFramefont) end)
	...
	slider5062:SetScript("OnValueChanged",
		function(self) FeralbyNightdb.bossfightFramefontsize = tostring(self:GetValue());
			do jj = 1, 5
				local bossfightFramedumb = _G["FeralbyNightbossfightFrame_" .. jj];
				bossfightFramedumb:SetFont("P", "Interface\\AddOns\\FeralbyNight\\arts\\fonts\\" .. FeralbyNightdb.bossfightFramefont
					, FeralbyNightdb.bossfightFramefontsize, "");
	...
	slider507:SetScript("OnValueChanged",
		function(self) FeralbyNight:SetmyfightFont(self:GetValue()); _G[self:GetName() .. "Text"]:SetText(self:GetValue()); fstring507
			:SetText("my fight buff/debuff Frame Font: " .. FeralbyNightdb.myfightFramefont) end)
